...
//note: now commenting value1,2, sending just cpm


SoftwareSerial mySerial= SoftwareSerial(10, 11); // RX, TX //to be sure it's easy to debug while the system is active
